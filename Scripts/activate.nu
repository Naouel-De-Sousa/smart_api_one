...
def-env activate-virtualenv [] {
    ...
    let virtual-env = 'C:\Users\adeld\.virtualenvs\smart_api-oCOq-1X2'
    let bin = 'Scripts'
    let path-sep = ';'
    ...
    let virtual-prompt = if ('smart_api' == '') {
...
alias deactivate = source 'C:\Users\adeld\.virtualenvs\smart_api-oCOq-1X2\Scripts\deactivate.nu'
